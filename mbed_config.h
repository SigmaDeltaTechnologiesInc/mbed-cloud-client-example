...
#define MBEDTLS_USER_CONFIG_FILE                                              "configs/wisun_mbedTLSConfig_mbedOS.h"                                                              // set by application[DISCO_F429ZI]
#define MBED_BOOTLOADER_SIZE                                                  (32*1024)                                                                                           // set by application
#define MBED_CLOUD_CLIENT_UPDATE_STORAGE                                      ARM_UCP_FLASHIAP                                                                                    // set by application[DISCO_F429ZI]
...
#define MBED_CONF_APP_TAG_PORT                                                PG_2                                                                                                // set by application[DISCO_F429ZI]
...
#define MBED_CONF_MBED_CLIENT_RECONNECTION_COUNT                              6                                                                                                   // set by application[*]
#define MBED_CONF_MBED_CLIENT_RECONNECTION_INTERVAL                           5                                                                                                   // set by library:mbed-client
#define MBED_CONF_MBED_CLIENT_SN_COAP_BLOCKWISE_MAX_TIME_DATA_STORED          300                                                                                                 // set by application[*]
...
#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_SECURITY_MODE                      NONE                                                                                                // set by application[*]
#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_SEC_LEVEL                          5                                                                                                   // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_CERTIFICATE_HEADER                            "configs/wisun_certificates.h"                                                                      // set by application[*]
#define MBED_CONF_MBED_MESH_API_HEAP_SIZE                                     32768                                                                                               // set by application[*]
...
#define MBED_CONF_MBED_MESH_API_WISUN_BC_DWELL_INTERVAL                       200                                                                                                 // set by application[*]
#define MBED_CONF_MBED_MESH_API_WISUN_BC_FIXED_CHANNEL                        0xffff                                                                                              // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_BC_INTERVAL                             1000                                                                                                // set by application[*]
...
#define MBED_CONF_MBED_MESH_API_WISUN_REGULATORY_DOMAIN                       9                                                                                                   // set by application[*]
#define MBED_CONF_MBED_MESH_API_WISUN_UC_CHANNEL_FUNCTION                     255                                                                                                 // set by library:mbed-mesh-api
#define MBED_CONF_MBED_MESH_API_WISUN_UC_DWELL_INTERVAL                       150                                                                                                 // set by application[*]
...
#define MBED_CONF_STORAGE_STORAGE_TYPE                                        TDB_INTERNAL                                                                                        // set by application[DISCO_F429ZI]
...
#define MBED_CONF_STORAGE_TDB_INTERNAL_INTERNAL_BASE_ADDRESS                  (MBED_ROM_START+1024*1024)                                                                          // set by application[DISCO_F429ZI]
#define MBED_CONF_STORAGE_TDB_INTERNAL_INTERNAL_SIZE                          (128*1024)                                                                                          // set by application[DISCO_F429ZI]
...
#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE                       MESH                                                                                                // set by application[DISCO_F429ZI]
...
#define MBED_CONF_UPDATE_CLIENT_APPLICATION_DETAILS                           (MBED_ROM_START + MBED_BOOTLOADER_SIZE)                                                             // set by application[DISCO_F429ZI]
#define MBED_CONF_UPDATE_CLIENT_BOOTLOADER_DETAILS                            0x080078CC                                                                                          // set by application[DISCO_F429ZI]
#define MBED_CONF_UPDATE_CLIENT_FIRMWARE_HEADER_VERSION                       0                                                                                                   // set by library:update-client
#define MBED_CONF_UPDATE_CLIENT_STORAGE_ADDRESS                               (MBED_CONF_STORAGE_TDB_INTERNAL_INTERNAL_BASE_ADDRESS+MBED_CONF_STORAGE_TDB_INTERNAL_INTERNAL_SIZE) // set by application[DISCO_F429ZI]
#define MBED_CONF_UPDATE_CLIENT_STORAGE_LOCATIONS                             1                                                                                                   // set by application[*]
#define MBED_CONF_UPDATE_CLIENT_STORAGE_PAGE                                  1                                                                                                   // set by application[DISCO_F429ZI]
#define MBED_CONF_UPDATE_CLIENT_STORAGE_SIZE                                  (1024*1024-MBED_CONF_STORAGE_TDB_INTERNAL_INTERNAL_SIZE)                                            // set by application[DISCO_F429ZI]
...
#define PAL_DTLS_PEER_MIN_TIMEOUT                                             10000                                                                                               // set by application[*]
...
#define STARTUP_MAX_RANDOM_DELAY                                              200                                                                                                 // set by application[*]
// Macros
...
#define MBEDTLS_NIST_KW_C                                                                                                                                                         // defined by application
#define MBEDTLS_PEM_PARSE_C                                                                                                                                                       // defined by application
